  ...
  <v-app :dark="dark">
    ...
    >
      <!--<v-toolbar flat class="transparent">-->
        <!--<v-list class="pa-0">-->
          <!--<v-list-tile avatar>-->
            <!--<v-list-tile-avatar class="pl-2">-->
              <!--<img src="../assets/1.jpeg">-->
            <!--</v-list-tile-avatar>-->
            <!--<v-list-tile-content>-->
              <!--<v-list-tile-title class="pl-2"><font style="font-family: KaiTi;font-size: 25px"><b>张娜娜</b></font></v-list-tile-title>-->
            <!--</v-list-tile-content>-->
          <!--</v-list-tile>-->
        <!--</v-list>-->
      <!--</v-toolbar>-->
